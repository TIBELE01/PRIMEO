...
jest.mock('../../modules/media/media.service', () => ({ mediaService: { upload: mockUpload } }));
...
describe('uploadMedia', () => {
  it('uploads a photo and creates ReviewMedia', async () => {
...
describe('deleteMedia', () => {
  it('deletes the media record', async () => {
    mockPrisma.reviewMedia.findUnique.mockResolvedValue({ id: 'm1', review: { authorId: 'u1' } });
  ...
  it('403 if not author', async () => {
    mockPrisma.reviewMedia.findUnique.mockResolvedValue({ id: 'm1', review: { authorId: 'other' } });
