...
jest.mock('../../../common/utils/mailer', () => ({ sendBookingConfirmationEmail: jest.fn(async () => undefined), sendTemplateEmail: jest.fn(async () => undefined), sendBookingInvoiceEmail: jest.fn(async () => undefined) }));
