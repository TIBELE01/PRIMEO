...
export const HOME_DEFAULTS = {
  ...
  products_preview: [
    { title: "Formules d'abonnement", description: "Choisissez la formule adaptée à votre activité — Essentiel, Prestige ou Premium. Commencez gratuitement et évoluez selon vos besoins.", badge: null, link: '/produits/' },
...
export const PRODUCTS_DEFAULTS = {
  ...
  plans: [
    { id: 'essential', slug: 'essential', name: 'Essentiel', price: '19 900', badge: null,       highlighted: false, ctaLabel: 'Choisir Essentiel', ctaUrl: '/contact/' },
    { id: 'prestige',  slug: 'prestige',  name: 'Prestige',  price: '49 900', badge: 'Populaire', highlighted: false, ctaLabel: 'Choisir Prestige',  ctaUrl: '/contact/' },
    { id: 'premium',   slug: 'premium',   name: 'Premium',   price: '99 900', badge: 'Best Value', highlighted: true, ctaLabel: 'Souscrire Premium', ctaUrl: '/contact/' },
  ],
  rows: [
    { feature: 'Commission par réservation',    highlight: true,  essential: '9 %',       prestige: '5 %',       premium: '0 %' },
    { feature: 'Propriétés incluses',           highlight: false, essential: '1',          prestige: '5',         premium: 'Illimité' },
    { feature: 'Badge Profil Vérifié',          highlight: false, essential: '✗',          prestige: '✓',         premium: '✓' },
    { feature: 'Badge Hôte Premium',            highlight: false, essential: '✗',          prestige: '✗',         premium: '✓' },
    { feature: 'Visibilité dans les résultats', highlight: false, essential: 'Standard',   prestige: '+30 %',     premium: 'Prioritaire' },
    { feature: 'Boosts gratuits / mois',        highlight: false, essential: '0',          prestige: '2',         premium: '10' },
    { feature: 'Support',                       highlight: false, essential: 'Email',      prestige: 'Prioritaire', premium: 'VIP' },
    { feature: 'Multi-utilisateurs',            highlight: false, essential: '✗',          prestige: '✗',         premium: '✓' },
    { feature: 'Visite 3D',                     highlight: false, essential: '✗',          prestige: '✓',         premium: '✓' },
    { feature: 'Statistiques',                  highlight: false, essential: 'Basiques',   prestige: 'Avancées',  premium: 'Expert' },
  ],
  boost: {
