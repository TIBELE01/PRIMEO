...
export default function RestaurantBookingDetailScreen({ route }: any) { return (<ScreenWrapper><View style={styles.c}><Text style={styles.t}>Réservation #{route.params?.bookingId}</Text></View></ScreenWrapper>); }
