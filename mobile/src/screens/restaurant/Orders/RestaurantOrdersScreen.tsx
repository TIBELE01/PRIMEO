// Restaurant-side food orders management screen.
// Receives propertyId as a prop (from the restaurant tab navigator context).
// Can also be used standalone — if no propertyId is provided, it fetches
// the authenticated user's first property automatically.
...
export default function RestaurantOrdersScreen({ propertyId }: Props) {
