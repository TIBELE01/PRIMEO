...
export default function RestaurantSettingsScreen() { return (<ScreenWrapper><View style={styles.c}><Text style={styles.t}>RestaurantSettingsScreen</Text></View></ScreenWrapper>); }
