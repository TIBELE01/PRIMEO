...
export default function RestaurantInvoicesScreen() { return (<ScreenWrapper><View style={styles.c}><Text style={styles.t}>RestaurantInvoicesScreen</Text></View></ScreenWrapper>); }
