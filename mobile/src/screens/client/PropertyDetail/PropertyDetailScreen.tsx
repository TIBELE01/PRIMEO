...
const styles = StyleSheet.create({
  ...
  badges: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, paddingHorizontal: 16, marginTop: 12, backgroundColor: '#fff' },
  badge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 10 },
  badgeText: { fontSize: 11, fontWeight: '700', color: '#fff' },

  titleBlock: { paddingHorizontal: 16, paddingTop: 10, paddingBottom: 14, backgroundColor: '#fff' },
  title: { fontSize: 22, fontWeight: '800', color: '#111827', lineHeight: 28 },
  locationRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 6 },
  location: { fontSize: 13, color: '#6B7280' },
  ratingRow: { flexDirection: 'row', alignItems: 'center', gap: 3 },
  star: { color: '#F59E0B', fontSize: 14 },
  rating: { fontSize: 14, fontWeight: '700', color: '#111827' },
  ...
  priceUnit: { fontSize: 12.5, color: '#6B7280', marginTop: 1, fontWeight: '600' },
  actionBtn: { paddingHorizontal: 20, paddingVertical: 13, borderRadius: 14 },
  actionBtnText: { color: '#fff', fontSize: 15, fontWeight: '800' },
  restaurantActions: { gap: 7 },
  orderBtn: { paddingHorizontal: 20, paddingVertical: 10, borderRadius: 14, borderWidth: 1.5, alignItems: 'center' },
  orderBtnText: { fontSize: 14, fontWeight: '700' },

  vtWrap: { paddingHorizontal: 16, marginTop: 10, marginBottom: 4 },
  ...
  stickyPrice: { fontSize: 17, fontWeight: '800' },
  stickyUnit: { fontSize: 12, color: '#6B7280', fontWeight: '600' },
  stickyCta: { paddingHorizontal: 22, paddingVertical: 13, borderRadius: 14 },
  stickyCtaText: { color: '#fff', fontSize: 15, fontWeight: '700' },
