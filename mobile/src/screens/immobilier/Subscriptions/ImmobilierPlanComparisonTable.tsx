...
export default function ImmobilierPlanComparisonTable() { return (<ScreenWrapper><View style={styles.c}><Text style={styles.t}>ImmobilierPlanComparisonTable</Text></View></ScreenWrapper>); }
