...
export default function ImmobilierSubscriptionScreen() { return (<ScreenWrapper><View style={styles.c}><Text style={styles.t}>ImmobilierSubscriptionScreen</Text></View></ScreenWrapper>); }
