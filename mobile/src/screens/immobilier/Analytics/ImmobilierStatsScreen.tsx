...
export default function ImmobilierStatsScreen() {
  ...
  const load = useCallback(async (silent = false) => {
    ...
    try {
      ...
      setData(all.filter((d) => d.propertyType === 'immobilier'));
    } catch {
      setData([]);
    } finally {
  ...
  return (
    <ScreenWrapper>
      ...
      >
        <Text style={styles.screenTitle}>Statistiques Immobilier</Text>
          ...
          <>
            <View style={styles.summaryCard}>
              ...
              <View style={styles.summaryItem}>
                ...
                <Text style={styles.summaryLbl}>Bien{data.length !== 1 ? 's' : ''}</Text>
              </View>
            </View>
            ...
            {data.length === 0 ? (
              ...
              <>
                <Text style={styles.sectionTitle}>Par bien</Text>
                {data.map((item) => {
