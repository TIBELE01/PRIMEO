...
export default function ImmobilierKYCStatusScreen() { return (<ScreenWrapper><View style={styles.c}><Text style={styles.t}>ImmobilierKYCStatusScreen</Text></View></ScreenWrapper>); }
