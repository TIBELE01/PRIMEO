...
export default function ImmobilierSettingsScreen() { return (<ScreenWrapper><View style={styles.c}><Text style={styles.t}>ImmobilierSettingsScreen</Text></View></ScreenWrapper>); }
