...
export default function ImmobilierPropertyCalendarScreen() { return (<ScreenWrapper><View style={styles.c}><Text style={styles.t}>ImmobilierPropertyCalendarScreen</Text></View></ScreenWrapper>); }
