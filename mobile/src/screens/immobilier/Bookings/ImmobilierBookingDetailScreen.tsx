...
export default function ImmobilierBookingDetailScreen({ route }: any) { return (<ScreenWrapper><View style={styles.c}><Text style={styles.t}>Location #{route.params?.bookingId}</Text></View></ScreenWrapper>); }
