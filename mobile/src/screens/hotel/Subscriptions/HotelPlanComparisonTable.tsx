...
export default function HotelPlanComparisonTable() { return (<ScreenWrapper><View style={styles.c}><Text style={styles.t}>HotelPlanComparisonTable</Text></View></ScreenWrapper>); }
