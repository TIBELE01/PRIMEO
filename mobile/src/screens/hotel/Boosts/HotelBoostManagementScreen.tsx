...
export default function HotelBoostManagementScreen() { return (<ScreenWrapper><View style={styles.c}><Text style={styles.t}>HotelBoostManagementScreen</Text></View></ScreenWrapper>); }
