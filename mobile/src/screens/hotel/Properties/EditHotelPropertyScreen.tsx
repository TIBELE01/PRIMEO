...
export default function EditHotelPropertyScreen() { return (<ScreenWrapper><View style={styles.c}><Text style={styles.t}>EditHotelPropertyScreen</Text></View></ScreenWrapper>); }
