...
export default function HotelPropertiesListScreen() { return (<ScreenWrapper><View style={styles.c}><Text style={styles.t}>HotelPropertiesListScreen</Text></View></ScreenWrapper>); }
