...
export default function AddHotelPropertyScreen() { return (<ScreenWrapper><View style={styles.c}><Text style={styles.t}>Ajouter propriété hôtel</Text></View></ScreenWrapper>); }
