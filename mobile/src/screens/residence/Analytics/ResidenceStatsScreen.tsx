...
export default function ResidenceStatsScreen() {
          ...
          <>
            ...
            <View style={styles.summaryCard}>
              ...
              <View style={styles.summaryItem}>
                ...
                <Text style={styles.summaryLbl}>Propriété{data.length !== 1 ? 's' : ''}</Text>
              </View>
            </View>
            ...
            {data.length === 0 ? (
              ...
              <>
                <Text style={styles.sectionTitle}>Par propriété</Text>
                {data.map((item) => {
...
const styles = StyleSheet.create({
  ...
  periodBtn: {
    ...
    backgroundColor: '#F3F4F6', fontSize: 13, fontWeight: '600', color: '#6B7280',
    overflow: 'hidden',
  },
